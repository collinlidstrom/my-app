...
const Pokemon = () => {
  ...
  return (<div className={`pokeCard pokeCard--${
    ...
    <div className='pokeCard__imgContainer'>
      <img className='pokeCard__img' src={`https://pokeres.bastionbot.org/images/pokemon/${id}.png`} alt='pokemon-pic'/>
    </div>
    ...
    <ul className='pokeCard__abilities'>
      {
        pokemon.abilities && pokemon.abilities.map((ability, index) => {
          return (<li className='pokeCard__ability' key={index}>
    ...
    <ul className='pokeCard__types'>
      {
        pokemon.types && pokemon.types.map((type, index) => {
          return (<li className='pokeCard__type' key={index}>
            {type['type']['name']}
          </li>);
        })
      }
